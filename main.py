...
def get_args_parser():
    ...
    # * VAT params
    parser.add_argument('--vat', type=float, default=1e-8,
                        help='vat lambda, vat enabled if > 0. (default: 0.8)')
...
def main(args):
    ...
    if args.resume:
        ...
        if 'model' in checkpoint:
            ...
            model_without_ddp.proj_head = torch.nn.Linear(1024, args.num_classes).to('cuda')
        else:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            args.clip_grad, model_ema, mixup_fn, args.vat, vat_fn, 
